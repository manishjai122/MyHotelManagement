<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPages/AdminMasterpage.Master" AutoEventWireup="true" CodeBehind="RoomType.aspx.cs" Inherits="FirstGoldmedalProject.Pages.AdminPages.RoomType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="firstFieldTyep">
        <h1 class="text-left"><asp:Label ID="Label9" runat="server"  ForeColor="#3366FF" Text="Room Type" Width="429px" Height="61px"></asp:Label></h1>
             <div class="one">
                 <div class="fields">
            ...
            <div class="two">
                <div class="gridew">
                <asp:GridView ID="ForRoomType" DataKeyNames="Id" width="80%"  runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnRowDeleting="ForRoomType_RowDeleting" OnSelectedIndexChanged="ForRoomType_SelectedIndexChanged">
                    <Columns>
